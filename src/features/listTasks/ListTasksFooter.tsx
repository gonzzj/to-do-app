...
const ListTasksFooter = ({ tasks, setListTasks, setFilter }: IListTasksFooterProps) => {
    ...
    return (
        <Grid container item alignItems={"center"} paddingX={2} paddingY={0}>
            ...
            <Grid item xs={4} container justifyContent="flex-end">
                <Button variant="text" onClick={() => setListTasks(tasksUncompleted)}>Clear completed tasks</Button>
            </Grid>
        </Grid>
    );
};
